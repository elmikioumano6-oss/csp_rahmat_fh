...
def afficher_login():
    st.markdown("""
        <style>
            ...
            /* --- CONTENEUR RESPONSIVE POUR MOBILE ET PC --- */
            .auth-container {
                display: flex;
            ...
            /* Ajustement automatique pour les petits écrans de téléphone */
    ...
    # Utilisation d'un conteneur centré fluide qui s'adapte au mobile
    ...
    with st.form("form_login_responsive"):
